...
<head>
    ...
    <link rel="stylesheet" href="{{ url('front/css/custom.css') }}">
        ...
        <!-- all css here -->
        <link rel="stylesheet" href="{{ url('front/css/len/bootstrap.min.css') }}">
        <link rel="stylesheet" href="{{ url('front/css/len/magnific-popup.css') }}">
        <link rel="stylesheet" href="{{ url('front/css/len/animate.css') }}">
        <link rel="stylesheet" href="{{ url('front/css/len/owl.carousel.min.css') }}">
        <link rel="stylesheet" href="{{ url('front/css/len/themify-icons.css') }}">
        <link rel="stylesheet" href="{{ url('front/css/len/pe-icon-7-stroke.css') }}">
        <link rel="stylesheet" href="{{ url('front/css/len/icofont.css') }}">
        <link rel="stylesheet" href="{{ url('front/css/len/meanmenu.min.css') }}">
        <link rel="stylesheet" href="{{ url('front/css/len/bundle.css') }}">
        <link rel="stylesheet" href="{{ url('front/css/len/style.css') }}">
        <link rel="stylesheet" href="{{ url('front/css/len/responsive.css') }}">
        <script src="front/js/vendor/jsss/modernizr-2.8.3.min.js"></script>
...
<script type="text/javascript" src="{{ url('front/js/easyzoom.js') }}"></script>
    ...
    <!-- all js here -->
    <script src="front/js/jsss/vendor/jquery-1.12.0.min.js"></script>
    <script src="front/js/jsss/jpopper.js"></script>
    <script src="front/js/jsss/bootstrap.min.js"></script>
    <script src="front/js/jsss/jquery.magnific-popup.min.js"></script>
    <script src="front/js/jsss/isotope.pkgd.min.js"></script>
    <script src="front/js/jsss/imagesloaded.pkgd.min.js"></script>
    <script src="front/js/jsss/jquery.counterup.min.js"></script>
    <script src="front/js/jsss/waypoints.min.js"></script>
    <script src="front/js/jsss/ajax-mail.js"></script>
    <script src="front/js/jsss/owl.carousel.min.js"></script>
    <script src="front/js/jsss/plugins.js"></script>
    <script src="front/js/jsss/main.js"></script>
