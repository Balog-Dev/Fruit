                    ...
                    <div class="card-people mt-auto">
                        ...
                        <div class="weather-info">
                            <div class="d-flex">
                                ...
                                <div class="ml-2">
                                    <h4 class="location font-weight-normal">Ibadan</h4>
                                    <h6 class="font-weight-normal">Oyo State</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4 stretch-card transparent">
                        <div class="card bg-success">
                            <div class="card-body">
                                <p class="mb-4 text-white">Total Bookings</p>
                                <p class="fs-30 mb-2 v text-white">61344</p>
                                <p class="text-white">22.00% (30 days)</p>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-xl-3 d-flex flex-column justify-content-start">
                                            <div class="ml-xl-4 mt-3">
                                                <p class="card-title">Detailed Reports</p>
                                                <h1 class="text-primary">$34040</h1>
                                                <h3 class="font-weight-500 mb-xl-4 text-primary">North </h3>
                                                <p class="mb-2 mb-xl-0">The total number of sessions within the date range. It is the period time a user is actively engaged with your website, page or app, etc</p>
                                            </div>
                                        </div>
                                        <div class="col-md-12 col-xl-9">
