        ...
        if($request->ajax()){
            ...
            if($validator->passes()){
                ...
                Mail::send('emails.confirmation',$messageData,function($message)use($email){
                    $message->to($email)->subject('Confirm your Fruitage Foods Account');
                });
                ...
                /*// Send Register SMS
                $message = "Dear Customer, you have been successfully registered with Fruitage Foods. Login to your account to access orders, addresses & available offers.";
                $mobile = $data['mobile'];
